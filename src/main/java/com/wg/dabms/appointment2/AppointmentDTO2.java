...
public class AppointmentDTO2 {
    ...
    public void prePersist() {
        this.dateTimeOfBookingOfAppointment = LocalDateTime.now();
        this.dateTimeOfUpdationOfAppointmentStatus = LocalDateTime.now();
        this.appointmentUuid = generateRandomString(16); // Generate random 16-character string
    }

    @PreUpdate
    public void preUpdate() {
        this.dateTimeOfUpdationOfAppointmentStatus = LocalDateTime.now(); // Update timestamp
    }
	
	public AppointmentDTO2() {
	}
	
	public AppointmentDTO2(String appointmentUuid, String doctorUuid, String patientUuid,
			AppointmentStatus appointmentStatus, LocalDate appointmentScheduledDate,
			AppointmentTimeSlot appointmentSlot, LocalDateTime dateTimeOfBookingOfAppointment,
			LocalDateTime dateTimeOfUpdationOfAppointmentStatus) {
		...
		this.dateTimeOfBookingOfAppointment = dateTimeOfBookingOfAppointment;
		this.dateTimeOfUpdationOfAppointmentStatus = dateTimeOfUpdationOfAppointmentStatus;
	}
